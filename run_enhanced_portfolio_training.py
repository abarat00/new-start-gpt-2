...
def create_enhanced_environment(args, valid_tickers, aligned_dfs_train, norm_params_paths, max_steps, output_dir, calendar=None):
    """
...
def main(args):
    ...
    # Load calendar once if requested (CHANGE HERE)
    calendar = None
    ...
    env = create_enhanced_environment(
        ...
        norm_params_paths, max_steps, output_dir, calendar=calendar
    )
